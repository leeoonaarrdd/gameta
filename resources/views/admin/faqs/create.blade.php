...
@section('title', 'Tambah Pertanyaan Umum - Admin Panel')
...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 sm:mb-8 animate-on-scroll-bounce">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-white animate-on-scroll">Tambah Pertanyaan Umum</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-6 sm:mt-8 animate-on-scroll-fade">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto sm:ml-auto animate-on-scroll-fade">
                    <button type="button" onclick="window.history.back()" class="text-white hover:text-gray-300 transition-colors duration-200 text-sm sm:text-base w-full sm:w-auto text-center">
                        Batal
                    </button>
