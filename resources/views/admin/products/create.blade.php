...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 sm:mb-8 animate-on-scroll-bounce">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-white animate-on-scroll">Tambah Produk</h1>
        </div>
    </div>
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                    ...
                    >
                        ...
                        <option value="Digiflazz" {{ old('provider') == 'Digiflazz' ? 'selected' : '' }}>Digiflazz</option>
                    </select>
                </div>
                @error('provider')
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                ...
                <!-- SKU -->
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                    <label for="sku" class="text-white font-medium w-full sm:w-32 flex-shrink-0 text-sm sm:text-base">Kode Produk</label>
                    <input 
                        type="text" 
                        id="sku" 
                        name="sku" 
                 ...
                 <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                     ...
                     <div class="w-full sm:w-110">
                         ...
                         <div class="text-xs text-gray-400 mt-1">
                             Harga akan diupdate otomatis setiap jam jika aktif
                         </div>
                     </div>
                 </div>
