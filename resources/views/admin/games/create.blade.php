...
@section('title', 'Tambah Games - Admin Panel')
...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 sm:mb-8 animate-on-scroll-bounce">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-white animate-on-scroll">Tambah Games</h1>
        </div>
    </div>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                    ...
                    <div class="w-full sm:w-110">
                        <input 
                            ...
                            required
                        >
                        <p class="text-gray-400 text-xs sm:text-sm mt-1">Gunakan ukuran gambar 600x800 px</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-4 animate-on-scroll-slide-up">
                    ...
                    >
                        ...
                        @foreach($targets as $target)
                            <option value="{{ $target->id }}" {{ old('sistem_target') == $target->id ? 'selected' : '' }}>{{ $target->judul_target }}</option>
                        @endforeach
                    </select>
                </div>
