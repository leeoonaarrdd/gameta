...
@section('content')
@php
    $kebijakanPrivasi = \App\Models\Configuration::getValue('kebijakan_privasi', '');
@endphp

<div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
    <!-- Header -->
    <div class="text-center mb-12 animate-on-scroll-bounce">
        <h1 class="text-4xl font-bold text-white uppercase tracking-wide animate-on-scroll">KEBIJAKAN PRIVASI</h1>
    </div>
    ...
    <div class="space-y-8">
        @if(!empty($kebijakanPrivasi))
            <div class="prose prose-invert max-w-none animate-on-scroll-fade">
                <div class="text-gray-300 leading-relaxed animate-on-scroll-slide-up">{!! $kebijakanPrivasi !!}</div>
            </div>
        @else
