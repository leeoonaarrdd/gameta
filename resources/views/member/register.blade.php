            ...
            <div class="w-full lg:w-1/2 p-8 lg:p-12 relative z-10 bg-gradient-to-r from-gray-950/95 via-gray-950/85 via-40% to-transparent backdrop-blur-md lg:bg-gradient-to-r lg:from-gray-950/95 lg:via-gray-950/85 lg:via-40% lg:to-transparent animate-on-scroll-fade">
                ...
                <div class="max-w-md mx-auto relative z-10">
                    <div class="text-center mb-8 animate-on-scroll-slide-up">
                        <h2 class="text-3xl font-bold text-white mb-2 animate-on-scroll">Register Member</h2>
                        <p class="text-gray-300 animate-on-scroll animate-on-scroll-delay-1">Daftar akun member baru</p>
                    </div>

                    @if(session('success'))
                        <div class="bg-green-500/20 border border-green-500/30 rounded-lg p-4 mb-6 animate-on-scroll-zoom">
                            <p class="text-green-400 text-sm">{{ session('success') }}</p>
                        </div>
                    @endif

                    @if(session('error'))
                        <div class="bg-red-500/20 border border-red-500/30 rounded-lg p-4 mb-6 animate-on-scroll-zoom">
                            <p class="text-red-400 text-sm">{{ session('error') }}</p>
                        </div>
                    @endif

                    <form class="space-y-6" method="POST" action="{{ route('member.register.post') }}">
                        @csrf
                        ...
                        <div class="animate-on-scroll animate-on-scroll-delay-1">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="username" 
                                    name="username" 
                                    class="w-full pl-12 pr-3 py-3 bg-gray-800/50 border border-gray-600/30 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm @error('username') border-red-500 @enderror"
                                    value="{{ old('username') }}"
                                    required
                                >
                            </div>
                        ...
                        <div class="animate-on-scroll animate-on-scroll-delay-2">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="email" 
                                    name="email" 
                                    class="w-full pl-12 pr-3 py-3 bg-gray-800/50 border border-gray-600/30 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm @error('email') border-red-500 @enderror"
                                    value="{{ old('email') }}"
                                    required
                                >
                            </div>
                        ...
                        <div class="animate-on-scroll animate-on-scroll-delay-3">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="phone" 
                                    name="phone" 
                                    class="w-full pl-12 pr-3 py-3 bg-gray-800/50 border border-gray-600/30 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm @error('phone') border-red-500 @enderror"
                                    value="{{ old('phone') }}"
                                    required
                                >
                            </div>
                        ...
                        <div class="animate-on-scroll animate-on-scroll-delay-4">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    id="password" 
                                    name="password" 
                                    class="w-full pl-12 pr-3 py-3 bg-gray-800/50 border border-gray-600/30 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm @error('password') border-red-500 @enderror"
                                    required
                                >
                            </div>
                            @error('password')
...
@push('scripts')
<script src="{{ asset('js/member-auth.js') }}"></script>
@endpush
@endsection
