...
<head>
    ...
    <title>@yield('title', 'Gameta - TopUp Game Terpercaya')</title>
    <meta name="keywords" content="@php echo \App\Models\Configuration::getValue('keywords', 'game, topup, voucher, pulsa, digital'); @endphp">
    <meta name="description" content="@php echo \App\Models\Configuration::getValue('description', 'Platform game terpercaya untuk topup dan pembelian voucher game favorit Anda'); @endphp">
    <meta name="author" content="@php echo \App\Models\Configuration::getValue('author', 'Gameta Team'); @endphp">
...
<body class="bg-gray-900 text-white">
    ...
    <!-- Navbar -->
    <nav x-data="{ isOpen: false }" class="relative overflow-hidden rounded-xl border border-gray-700/30">
        <!-- Animated Background -->
        <div class="absolute inset-0 bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 backdrop-blur-md"></div>
        
        <!-- Floating Bubbles -->
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute h-4 w-4 rounded-full bg-gray-600/20 animate-float top-4 left-[10%]"></div>
            <div class="absolute h-3 w-3 rounded-full bg-gray-600/20 animate-float top-8 left-[20%] [animation-delay:0.5s]"></div>
            <div class="absolute h-5 w-5 rounded-full bg-gray-600/20 animate-float top-6 left-[80%] [animation-delay:1s]"></div>
            <div class="absolute h-6 w-6 rounded-full bg-gray-600/20 animate-float top-2 left-[60%] [animation-delay:1.5s]"></div>
        </div>

        <!-- Main Navbar Content -->
        <div class="relative px-4 sm:px-8 py-1">
            <div class="flex items-center justify-between max-w-6xl mx-auto lg:px-8">
                <!-- Logo and Search -->
                <div class="flex items-center space-x-8">
                    ...
                    <a href="/" class="flex items-center space-x-3 group">
                        ...
                        @endphp
                        @if(!empty($logo))
                            <img src="{{ asset('storage/' . $logo) }}" alt="Logo" class="w-24 sm:w-28 h-12 sm:h-16 object-contain transform group-hover:scale-110 transition-transform duration-300">
                        @else
                            <svg class="w-8 sm:w-10 h-8 sm:h-10 text-white transform group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Search Bar -->
                    <div class="hidden sm:flex relative search-container">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                            </svg>
                        </div>
                        <input type="text" placeholder="Cari game..." class="search-input-desktop pl-12 pr-4 py-2 bg-gray-800/50 border border-gray-600/30 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm w-64 lg:w-80">
                    </div>
                    <!-- Search Results Container (Outside Navbar) -->
                    <div class="search-results-desktop hidden fixed top-20 left-1/2 transform -translate-x-1/2 w-80 lg:w-96 bg-gray-900/95 backdrop-blur-md border border-gray-700/50 rounded-lg shadow-2xl z-[9999] max-h-96 overflow-y-auto"></div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <a href="/cek-pesanan" class="relative group">
                            <span class="text-gray-300 group-hover:text-white transition-colors duration-300">Cek Pesanan</span>
                            <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-purple-400 group-hover:w-full transition-all duration-300"></div>
                            <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-white/20 group-hover:w-full transition-all duration-500 delay-100"></div>
                        </a>
                        <a href="/daftar-harga" class="relative group">
                            <span class="text-gray-300 group-hover:text-white transition-colors duration-300">Daftar Harga</span>
                            <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-purple-400 group-hover:w-full transition-all duration-300"></div>
                            <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-white/20 group-hover:w-full transition-all duration-500 delay-100"></div>
                        </a>
                    </div>
                    ...
                    @auth('member')
                        <div class="hidden sm:flex items-center space-x-4">
                            <a href="{{ route('member.dashboard') }}" class="hidden sm:flex relative group">
                                <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-purple-400 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-200"></div>
                                <div class="relative px-5 sm:px-7 py-2 sm:py-3 bg-gray-900 rounded-lg leading-none flex items-center">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-gray-300 group-hover:text-white transition duration-200">Beranda</span>
                                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transform group-hover:translate-x-1 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                        <a href="{{ route('member.login') }}" class="hidden sm:flex relative group">
                            <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-purple-400 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-200"></div>
                            <div class="relative px-5 sm:px-7 py-2 sm:py-3 bg-gray-900 rounded-lg leading-none flex items-center">
                                <div class="flex items-center space-x-2">
                                    <span class="text-gray-300 group-hover:text-white transition duration-200">Login</span>
                                    <svg class="w-5 h-5 text-gray-300 group-hover:text-white transform group-hover:translate-x-1 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                                    </svg>
                                </div>
                    ...
                    <button @click="isOpen = !isOpen" class="md:hidden relative group" aria-label="Toggle mobile menu">
                        <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-purple-400 rounded blur opacity-60 group-hover:opacity-100 transition duration-200"></div>
                        <div class="relative p-2 bg-gray-900 rounded leading-none">
                            <svg x-show="!isOpen" class="w-6 h-6 text-gray-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="isOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="relative mt-4 md:hidden">
                <div class="px-2 pt-2 pb-3 space-y-1 bg-gray-900/50 backdrop-blur-sm rounded-lg border border-gray-700/10">
                    <!-- Mobile Search Bar -->
                    <div class="px-3 py-2 search-container">
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                            ...
                            <input type="text" placeholder="Cari game..." class="search-input-mobile w-full pl-12 pr-4 py-2 bg-gray-800/50 border border-gray-600/30 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/60 backdrop-blur-sm">
                        </div>
                    </div>
                    <!-- Mobile Search Results Container (Outside Navbar) -->
                    <div class="search-results-mobile hidden fixed top-20 left-4 right-4 bg-gray-900/95 backdrop-blur-md border border-gray-700/50 rounded-lg shadow-2xl z-[9999] max-h-96 overflow-y-auto"></div>
                    
                    <a href="/cek-pesanan" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all duration-200">Cek Pesanan</a>
                    <a href="/daftar-harga" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all duration-200">Daftar Harga</a>
                    
                    <!-- Mobile CTA Button -->
                    @auth('member')
                        <div class="px-3 py-2">
                            <a href="{{ route('member.dashboard') }}" class="block w-full relative group">
                                <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-purple-400 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-200"></div>
                                <div class="relative px-4 py-2 bg-gray-900 rounded-lg leading-none flex items-center justify-center">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-gray-300 group-hover:text-white transition duration-200">Beranda</span>
                                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transform group-hover:translate-x-1 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                    ...
                    @else
                    <div class="px-3 py-2">
                        <a href="{{ route('member.login') }}" class="block w-full relative group">
                            <div class="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-purple-400 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-200"></div>
                            <div class="relative px-4 py-2 bg-gray-900 rounded-lg leading-none flex items-center justify-center">
                                <div class="flex items-center space-x-2">
                                    <span class="text-gray-300 group-hover:text-white transition duration-200">Login</span>
    ...
    @stack('scripts')
         ...
         <!-- Footer -->
         <footer class="bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 border border-gray-700/30">
          <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="flex justify-center text-teal-600 dark:text-teal-300">
              ...
              @else
                  <svg class="h-16" viewBox="0 0 118 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-300">
              @php echo \App\Models\Configuration::getValue('description', 'Platform game terpercaya untuk topup dan pembelian voucher game favorit Anda'); @endphp
            </p>
            ...
            <ul class="mt-12 flex justify-center gap-6 md:gap-8">
              ...
              @empty
                  <!-- Default social media icons if no data -->
                  <li>
                      <a href="#" rel="noreferrer" target="_blank" class="text-gray-300 transition hover:text-white">
